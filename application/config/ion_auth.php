...
$config['tables']['groups_translation']     = 'groups_translation';
...
$config['join']['groups_translation'] = 'group_id';
 ...
 */
$config['site_title']                 = "penderie";       // Site Title, example.com
$config['admin_email']                = "admin@penderie.net"; // Admin Email, admin@example.com
$config['default_group']              = 'id';           // Default group, use name
...
$config['user_expire']                = 2592000;               // How long to remember the user (seconds). Set to zero for no expiration
