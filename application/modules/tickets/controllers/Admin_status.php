...
class Admin_status extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['count_all_records']    = $this->admin_status_model->get_count_all_categories($lang_id);
        ...
        $this->data['search_fields']        = array( lang('status'));
    ...
    public function ajax_list()
    {
        ...
        $grid_data       = $this->admin_status_model->get_cateories_data($lang_id,$limit,$offset,$search_word,$order_by,$order_state);
       ...
       $new_grid_data = array();
        ...
        $this->data['count_all_records'] = $this->admin_status_model->get_count_all_categories($lang_id,$search_word);
    ...
    public function read($id,$display_lang_id)
    {
        ...
        {
            $data     = $this->admin_status_model->get_row_data($id,$display_lang_id);
    ...
    public function delete()
    {
        ...
        $this->admin_status_model->delete_category_data($ids_array);
   ...
   /**************************************************************************/ 
    ...
    public function add()
    {
        ...
        else
        {
            ...
            if($this->admin_status_model->insert_tickets_status($general_data))
            {
                ...
                foreach($languages as $lang_id)
                {
                    $cat_translation_data = array(
                                                        'ticket_status_id'   => $last_insert_id     ,
                                                        'title'           => $cat_name[$lang_id] ,
                                                        'lang_id'         => $lang_id ,
                                                     );
                    $this->admin_status_model->insert_tickets_status_translation($cat_translation_data);
               }
                
                $_SESSION['success'] = lang('success');
                $this->session->mark_as_flash('success'); 
                 
                redirect('tickets/admin_status/','refresh');
            }
        }
    }
    ...
    private function _add_form($validation_msg)
    {
        ...
        $this->data['content']      = $this->load->view('admin_status', $this->data, true);
        $this->load->view('Admin/main_frame',$this->data);
    }
    ...
    public function edit($id)
    {
        if(is_numeric($id))
        {
            ...
            else
            {
                ...
                $this->admin_status_model->update_category($cat_id,$general_data);
                ...
                foreach($languages as $lang_id)
                {
                    ...
                    $this->admin_status_model->update_cat_translation($cat_id,$lang_id,$cat_translation_data);
    ...
    private function _edit_form($id, $validation_msg)
    {
        ...
        $general_data               = $this->admin_status_model->get_category_row($id); 
        $data                       = $this->admin_status_model->get_category_translation_result($id);
    ...
    public function update()
    {
        ...
        else
        {
           ...
           redirect('tickets/admin_status/index','refresh');
        }
