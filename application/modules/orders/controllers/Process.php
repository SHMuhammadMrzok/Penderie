<?php
include_once("includes/paypal/config.php");
include_once("includes/paypal/paypal.class.php");
...
if($_POST) //Post Data received from product list page.
{
    ...
    $ItemName2 		= $_POST["itemname2"]; //Item Name
	$ItemPrice2 	= $_POST["itemprice2"]; //Item Price
	$ItemNumber2 	= $_POST["itemnumber2"]; //Item Number
	$ItemDesc2 		= $_POST["itemdesc2"]; //Item Number
	$ItemQty2 		= $_POST["itemQty2"]; // Item Quantity
    
	$ItemTotalPrice = ($ItemPrice*$ItemQty) + ($ItemPrice2*$ItemQty2); //(Item Price x Quantity = Total) Get total amount of product; 
	...
	$padata = 	'&METHOD=SetExpressCheckout'.
				...
				*/
                ...
                $_SESSION['ItemName2'] 			=  $ItemName2; //Item Name
				$_SESSION['ItemPrice2'] 		=  $ItemPrice2; //Item Price
				$_SESSION['ItemNumber2'] 		=  $ItemNumber2; //Item Number
				$_SESSION['ItemDesc2'] 			=  $ItemDesc2; //Item Number
				$_SESSION['ItemQty2'] 			=  $ItemQty2; // Item Quantity
...
if(isset($_GET["token"]) && isset($_GET["PayerID"]))
{
	...
	$ItemQty2 			= $_SESSION['ItemQty2']; // Item Quantity
