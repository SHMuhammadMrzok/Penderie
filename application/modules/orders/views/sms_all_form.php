    ...
    <body>
        <div class="iner_page">
            <div class="container">
                  ...
                  <form method="post" action="<?php echo base_url();?>orders/sms_serials/sms_all_serials" onsubmit="return closeSelf(this);>
                    ...
                    <div class="row no-margin margin-bottom-10px">
                        ...
                        <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <textarea class="form-control" id="message" name="message" readonly="readonly">
                                <?php echo $msg; ?>
                            </textarea>
                        </div><!--col-->    
                    </div><!--row-->
