                          ...
                          <ul class="slider">
                            <?php foreach($field->options as $key=>$option){?>
                                <li id="item-<?php echo $key+1;?>">
                                  <div class="color " title="<?php echo $option->field_value;?>">
                                    <?php if($option->image != ''){?>
                                      <img src="<?php echo base_url();?>assets/uploads/products/<?php echo $option->image;?>" alt="<?php echo $product->title;?>"/>
                                    <?php }else{?>
                ...
                <div class="quantity-card">
                    ...
                    <?php /*<div class="quant">
                        <form action="#">
                            ...
                            <input type="text" placeholder="1" value="1" name="product_qty" class="form-control product_qty"/>
