    ...
    <div class="tabbable-custom form">
	   <ul class="nav nav-tabs ">
    	...
    	<div class="tab-content">
                ...
                <?php /*<div class="form-group">
                       ...
                       <div class="col-md-4">
                            ...
                            <?php
                                ...
                                echo form_dropdown('cat_id', $categories, $cat_id, 'class="form-control select2"');
                            ?>
                        </div>
                    </div>
                     */?>
               ...
               <div class="form-group">
                   ...
                   <div class="col-md-4">
                     <?php
                        ...
                        $active_value = false ;
                        if($mode == 'edit' && !isset($validation_msg) && isset($general_data))
                        {
            ...
            <?php } ?>
            <?php  echo isset($id) ? form_hidden('brand_id', $id) : ''; ?>
