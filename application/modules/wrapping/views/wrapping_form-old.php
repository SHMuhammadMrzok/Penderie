	      ...
	      <div class="form-body">
            <!--<div class="form-group">
                <label class="control-label col-md-3">
                  <?php echo lang('box_size');?><span class="required">*</span>
                </label>
               <div class="col-md-4">
                <?php    
                    echo form_error("box_size");
                    $box_size_data = array('name'=>"box_size" , 'class'=>"form-control" , 'value'=> isset($general_data->box_size)? $general_data->box_size : set_value("box_size"));
                    
                    echo form_input($box_size_data); 
                ?>
               </div>
                          ...
                          if(isset($general_data->image) && ($general_data->image!=''))
                          {
                            ...
                            $display_image_div = '
                                                  <div id="success_'.$unique_id.'" class="upload-success-url" style=" padding-top: 7px; display: block;">
                                                      <a href="'.$upload_path.$general_data->image.'" id="file_'.$unique_id.'" class="open-file image-thumbnail" target="_blank">
        ...
        <?php foreach($data_languages as $key=> $lang){ ?>
    		...
    		<div class="tab-pane" id="tab_lang_<?php echo $lang->id; ?>">
    		      <div class="form-body">
                    ...
                    <div class="form-group">
                       <label class="control-label col-md-3">
                         <?php echo lang('wrapping_type');?><span class="required">*</span>
                       </label>
                       <div class="col-md-4">
                          <?php 
                                echo form_error("wrapping_type[$lang->id]");
                                $wrapping_data = array('name'=>"wrapping_type[$lang->id]" , 'class'=>"form-control" , 'value'=> isset($data[$lang->id]->wrapping_type)? $data[$lang->id]->wrapping_type : set_value("wrapping_type[$lang->id]"));
                                echo form_input($wrapping_data);
                          ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                       <label class="control-label col-md-3">
                         <?php echo lang('ribbon_type');?><span class="required">*</span>
                       </label>
                       <div class="col-md-4">
                          <?php 
                                echo form_error("ribbon_type[$lang->id]");
                                $ribbon_data = array('name'=>"ribbon_type[$lang->id]" , 'class'=>"form-control" , 'value'=> isset($data[$lang->id]->ribbon_type)? $data[$lang->id]->ribbon_type : set_value("ribbon_type[$lang->id]"));
                                echo form_input($ribbon_data);
                          ?>
                        </div>
                    </div>
