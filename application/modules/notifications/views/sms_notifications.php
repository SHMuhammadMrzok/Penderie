...
<?php $att=array('class'=> 'form-horizontal form-bordered cmxform');
    ...
    <div class="form-body">
        ...
        <div class="form-group">
            <label class="control-label col-md-3"><?php echo lang('mobile');?><span class="required">*</span></label>
           <div class="col-md-4">
              <?php 
                   echo form_error("mobile");  
                   $mobile_data = array('name'=>"mobile" , 'class'=>"form-control " , 'value'=> isset($general_data->mobile)? $general_data->mobile : set_value('mobile',''));
                   echo form_input($mobile_data);
              ?>
              <span><?php echo lang('mobile_right_format');?></span>
           </div>
        </div><!--mobile div-->
