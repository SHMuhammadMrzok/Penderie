         ...
         <?php if(isset($variables_data)){?>
             <li class="">
    			<a href="#tab_variables" data-toggle="tab">
    			     ...
    			     <span class="langname"><?php echo lang('variables_definitions'); ?> </span>
                </a>
    		 </li>
       <?php }?>
	...
	<div class="tab-content">
        <div class="tab-pane active " id="tab_general">
            ...
            <div class="tab-pane  " id="tab_variables">
		      <div class="form-body"> 
                <?php if(isset($variables_data) && count($variables_data)>0){?>
            ...
            <?php foreach($data_languages as $key=> $lang){ ?>
    		  ...
    		  <div class="tab-pane" id="tab_lang_<?php echo $lang->id; ?>">
    		      <div class="form-body">
                    ...
                    <div class="form-group">
                      <label class="control-label col-md-3">
                        <?php echo lang('admin_template');?><span class="required">*</span>
                      </label>
                        
                        <div class="col-md-4">
                            <?php 
                                    echo form_error("admin_template[$lang->id]");
                                    $template = array('name'=>"admin_template[$lang->id]" , 'class'=>"form-control" , 'value'=> isset($data[$lang->id]->template)? $data[$lang->id]->template : set_value("admin_template[$lang->id]"));
                                    echo form_textarea($template);
                            ?>
                        </div>
