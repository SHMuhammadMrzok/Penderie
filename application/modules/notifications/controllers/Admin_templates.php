...
class Admin_templates extends CI_Controller
{
    public   $lang_row;
    public function __construct()
    {
        ...
        $this->load->model('admin_templates_model');
    ...
    {   
        ...
        $this->data['count_all_records'] = $this->admin_templates_model->get_count_all_admin_templates($lang_id);
    ...
    public function ajax_list()
    {
        ...
        $grid_data  = $this->admin_templates_model->get_admin_template_data($lang_id ,$limit, $offset, $search_word, $order_by, $order_state);
        ...
        $this->data['count_all_records']  = $this->admin_templates_model->get_count_all_admin_templates($lang_id, $search_word);
     ...
     public function read($id,$display_lang_id)
     {
        ...
        {
            $data = $this->admin_templates_model->get_row_data($id,$display_lang_id);
     ...
     public function delete()
     {
        ...
        $is_used_template = $this->admin_templates_model->check_used_template($ids_array);
        ...
        {
            $this->admin_templates_model->delete_emails_template_data($ids_array);
        }
    ...
    public function add()
    {
        ...
        if(strtoupper($_SERVER['REQUEST_METHOD']) == 'POST')
        {
            ...
            { 
                ...
                $this->form_validation->set_rules('admin_template['.$lang_id.']', lang('admin_template') , 'trim|required');
        ...
        else
        {
            ...
            if($this->admin_templates_model->insert_template_data($template_general_data))
            {
                $last_insert_id       = $this->db->insert_id();
                $lang_id	          = $this->input->post('lang_id');
                $template_name        = $this->input->post('name');
                $admin_template       = $this->input->post('admin_template');
                ...
                foreach($languages as $lang_id)
                {
                    ...
                    $template_translation_data = array(
                                                        ...
                                                        'template'       => $admin_template[$lang_id],
                    ...
                    $this->admin_templates_model->insert_template_translation($template_translation_data);
                }
                
                $_SESSION['success'] = lang('success');
                $this->session->mark_as_flash('success');   
                
                redirect('notifications/admin_templates/','refresh');
            }
        }
    }
    ...
    private function _add_form($validation_msg)
    {
        ...
        $this->data['content']      = $this->load->view('admin_templates', $this->data, true);
        $this->load->view('Admin/main_frame',$this->data);
    }
    ...
    public function edit($id)
    {
        ...
        else
        {
            ...
            $this->admin_templates_model->update_template($temp_id,$template_data);
            ...
            foreach($languages as $lang_id)
            {
                ...
                $this->admin_templates_model->update_template_translation($temp_id,$lang_id,$template_translation_data);
            }
    ...
    private function _edit_form($id, $validation_msg)
    {
        ...
        $this->data['id']           = $id;
        $lang_id                    = $this->data['active_language']->id;
        $general_data               = $this->admin_templates_model->get_template_row($id); 
        $data                       = $this->admin_templates_model->get_template_translation($id);
        $variables_data             = $this->admin_templates_model->get_event_variables($id, $lang_id);
