...
class templates_model extends CI_Model
{
    ...
    public function get_count_all_templates($lang_id,$search_word='')
    {
    ...
    public function get_template_data($lang_id,$limit,$offset,$search_word,$order_by='',$order_state)
    {
    ...
    {
        $this->db->where_in('template_id', $temp_ids_array);
   ...
   public function update_template_translation($temp_id,$lang_id,$template_translation_data)
   {
        ...
        $this->db->update('templates_translation',$template_translation_data);
   }
