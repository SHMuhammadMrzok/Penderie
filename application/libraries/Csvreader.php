...
class Csvreader {
     ...
     * @return    array
     */
    function parse_file($p_Filepath, $p_NamedFields = true, $seperator='') {
        $content = false;
        ...
        if($p_NamedFields) {
            $this->fields = fgetcsv($file, $this->max_row_size, $seperator, $this->enclosure);
        }
        while( ($row = fgetcsv($file, $this->max_row_size, $seperator, $this->enclosure)) != false ) {
