  ...
  <header class="header-2">
                        ...
                        <div class="container-top-header">
                            ...
                            <div class="lang-area">
                                <?php foreach($languages as $lang){
                                    if($lang->language != $active_lang){?>
                                        <a href="<?php echo base_url().'front_end_global/change_lang_country/'. $lang->id?>"><?php echo $lang->name?></a>
                                <?php }
                                }?>
                            ...
                            <div class="country-area">
                                <?php /*<form action="<?php echo base_url();?>front_end_global/change_lang_country" id="count_lang_form" class="d-flex site-setting" method="post">
                                    <div class="country-body-dim"></div>
                                    <div class="form-item">
                                        <input id="country_selector" type="text" readonly="readonly">
                                    </div>
                                    <select name="country_id" id="countries">
                                    <?php foreach($countries as $country) {?>
                                    <div class="flag <?php echo strtolower($country->country_symbol);?>"></div>
                                        <option data-country-code="<?php echo strtolower($country->country_symbol);?>" value='<?php echo $country->id?>' data-title="<?php echo $country->name;?>" <?php echo $country->id==$_SESSION['country_id'] ? 'selected':'';?> >
                                                <div class="flag <?php echo strtolower($country->country_symbol);?>"></div><?php echo $country->name;?>
                                        </option>
                            ...
                            <div class="nav-list">
                                <div class="gray-bgusershop d-flex justify-content-center align-items-center flex-row">
                                    <div class="wishlist-box">
                                        <div class="icon">
                                            <a href="<?php echo base_url();?>Wishlist">
                                                <span class="whishlist_count"><?php echo $fav_products_count;?></span>
                                                <svg>
                                    ...
                                    <div class="user-body-dim"></div>
                                    <div class="user-area">
                                            <button class="user-after-log space-nowrap">
                                    ...
                                    <?php
                                      /*<div class="balance">
                                          ...
                                          <h1><?php echo $user_balance_new;?> <span><?php echo $currency;?></span></h1>
      ...
      <div class="search-area form-search-mobile">
        <form action="<?php echo base_url(); ?>products/products/search" method="post">
          <!-- class="sear"-->
          <input type="text" value="<?php echo isset($product_name)? $product_name : ''; ?>" placeholder="<?php echo isset($product_name)? $product_name : lang ('search_word'); ?>" name="product_name"/>
          <button>
            <svg>
                    ...
                    <div class=nav-menus-wrapper>
                        <ul class=nav-menu>
                            <li><a href="<?php echo base_url();?>"><?php echo lang('home');?></a></li>
                             ...
                             <?php if(isset($categories_array[0])){
                            ...
                            <?php /*<li><a href="<?php echo base_url().'All_stores/';?>"><?php echo lang('all_stores');?></a></li>*/?>
                        </ul>
                        ...
                        <div class="area-mobile">
                            <div class="lang">
                                ...
                                <ul>
                                    <?php foreach($languages as $lang){
                                        if($lang->language != $active_lang){?>
                                            <li><a href="<?php echo base_url().'front_end_global/change_lang_country/'. $lang->id?>"><?php echo $lang->name?></a></li>
                                    <?php }
                                    }?>
                                </ul>
                            </div>
...
<section class="popup-area" style="display:none;">
  ...
  <div class="pop-content">
    <div class="white-row">
      <div class="add-cart-row" style="background: #fff!important; border: 2px solid #fff!important;">
        <div class="row no-gutters align-item-center w-100">
          <div class="image-product" style="border-right: 2px solid #fff!important;">
          ...
          <div class="summary">
              ...
              <div class="cart-sum">
                <p><?php echo lang('final_total');?><span> </span>:<span class="num cart_total_price" style="color: #ccda00!important;"></span></p>
              </div>
          </div>
      ...
      <div class="action">
        <ul>
          ...
          <li><a href="<?php echo base_url();?>Cart_Address" class="proceed"><?php echo lang('proceed_to_checkout');?><span> </span></a></li>
        </ul>
      </div>
    </div>
            ...
            <div class="col">
              ...
              <div class="module-body">
                <ul class='list-unstyled'>
                  ...
                  <li class="first"><a href="<?php echo base_url();?>Page_Details/2" title="<?php echo lang('about');?>"><?php echo lang('about');?></a></li>
              ...
              <div class="module-body">
                <ul class='list-unstyled'>
                  ...
                  <?php if($this->config->item('business_type') == 'b2b' && ! $is_logged_in){?>
                      ...
                      <?php /*<li class="last"><a href="<?php echo base_url();?>Page_Details/9" title="<?php echo lang('warranty_policy');?>"><?php echo lang('warranty_policy');?></a></li>*/ ?>
                  <?php }?>
                </ul>
              </div>
            </div>
          ...
          <div class="col-md-6 no-padding social">
            <ul class="link">
              ...
              <?php if($this->config->item('facebook') != ''){?>
                <li class="fb pull-left"><a target="_blank" href="https://www.facebook.com/<?php echo $this->config->item('facebook');?>" title="Facebook">
                    <svg>
              ...
              <?php if($this->config->item('twitter') != ''){?>
                <li class="tw pull-left"><a target="_blank" href="https://twitter.com/<?php echo $this->config->item('twitter');?>" title="Twitter">
                    <svg>
              ...
              <?php if($this->config->item('instagram') != ''){?>
                <li class="insta pull-left"><a target="_blank" href="https://www.instagram.com/<?php echo $this->config->item('instagram');?>" title="instagram">
                    <svg>
              ...
              <?php if($this->config->item('linkedin') != ''){?>
                  <li class="linkedin pull-left"><a target="_blank" href="https://www.linkedin.com/company/<?php echo $this->config->item('linkedin');?>" title="Linkedin">
                      <svg>
              ...
              <?php if($this->config->item('youtube') != ''){?>
                  <li class="youtube pull-left"><a target="_blank" href="http://www.youtube.com/channel/<?php echo $this->config->item('youtube');?>" title="Youtube">
                      <svg>
...
<div class="loading_modal"><!-- Place at bottom of page --></div>
  ...
  <script src="<?php echo base_url();?>assets/template/site/js/un-min-js/countrySelect.js"></script>
    <script src="<?php echo base_url();?>assets/template/site/js/un-min-js/svg.js"> </script>
    <script>
...
<script>
    ...
    $.post( '<?php echo base_url()."products/products/add_to_wishlist/";?>', postData, function ( data ) {
      ...
      */
      ...
      if ( data == 'product_required' ) {
        ...
        var new_count = Number($('.whishlist_count').html()) + Number(1);
        $('.whishlist_count').html(new_count);
      }
    } );
  } );
  ...
  $( '.cart' ).click( function ( event ) {
    ...
    $.post( '<?php echo base_url()."shopping_cart/cart/add_to_cart/";?>', postData, function ( data ) {
      ...
      if ( data[ 0 ] == 'no_stock' ) {
        ...
        var img_src  = '<?php echo $images_path;?>' + data[ 2 ];
  ...
  $( "body" ).on( "click", ".add_optional_fields", function ( event ) {
    ...
    var postData = $( '#optional_fields_form' ).serialize() + '&=qty=' + product_qty;
    ...
    $.post( '<?php echo base_url()."shopping_cart/cart/submit_product_optional_fields";?>', postData, function ( result ) {
      if ( result[ 0 ] == 1 ) {
        ...
        var cur_count   = $( '.cart_items_count' ).html();
        var new_count = Number( cur_count ) + Number( product_qty );
