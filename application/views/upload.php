<?php
$subfolder = $this->config->item('amazon_s3_subfolder');//"/qhwastore";
$access_key 		= $this->config->item('amazon_s3_access_key');//"AKIAJSBXCQ7BCMQVDJNA"; //Access Key
$secret_key 		= $this->config->item('amazon_s3_secret_key');//"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"; //Secret Key
$my_bucket			= $this->config->item('amazon_s3_my_bucket');//"sbmcart"; //bucket name
$region					= $this->config->item('amazon_s3_region');//"eu-west-2"; //bucket region
...
$allowd_file_size	= "10097152"; //1 MB allowed Size
