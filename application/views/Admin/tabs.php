	...
	<ul class="nav nav-tabs ">
		<li class="active">
			<a href="#tab_5_1" data-toggle="tab">
                <img alt="" src="<?php echo base_url();?>/assets/template/admin/global/img/flags/us.png" />
			     <span class="langname">English </span>
            </a>
		</li>
		<li>
			<a href="#tab_5_2" data-toggle="tab">
			     <img alt="" src="<?php echo base_url();?>/assets/template/admin/global/img/flags/eg.png" />
			     <span class="langname">عربى </span>
            </a>
		</li>
		<li>
