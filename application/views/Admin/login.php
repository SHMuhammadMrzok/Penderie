<?php $direction = '';
//echo "lang" . $this->session->userdata('lang');
...
<link href="<?php echo base_url();?>assets/template/admin/pages/css/login-soft<?php echo $direction;?>.css" rel="stylesheet" type="text/css"/>
...
<link id="style_color" href="<?php echo base_url();?>assets/template/admin/layout/css/themes/darkblue<?php echo $direction;?>.css" rel="stylesheet" type="text/css"/>
...
<div class="logo">
	<a href="">
    <img style="width:300px!important;" src="<?php echo base_url();?>assets/uploads/<?php echo $this->config->item('logo');?>" alt=""/>
	</a>
</div>
<!-- END LOGO -->
...
<div class="content">
    ...
    <?php
    $form_atts = array('class=>"login-form"');
    echo form_open('', $form_atts);?>
	   ...
	   <?php } ?>
       <?php  if(isset($forget_message))   { ?>
            <div class="alert alert-danger">
    		      <button class="close" data-close="alert"></button>
    		      <?php echo $forget_message;?>
            </div>
	   <?php } ?>
	   <div class="form-body">
    	...
    	<div class="form-group">
			...
			<div class="input-icon">
                ...
                <?php
                 ...
                 $email_data = array('name'=>'email','class'=>'form-control placeholder-no-fix','placeholder'=>lang('email'));
		...
		<div class="form-group">
			...
			<div class="input-icon">
                ...
                <?php
                 ...
                 $password_data = array('name'=>'password','class'=>'form-control placeholder-no-fix','placeholder'=>lang('password'));
    	...
    	<div class="form-group">
			<select name="lang" id="select2_sample4" class="form-control select2 col-md-4">
			 <?php foreach($structure_languages as $lang){?>
            	<option value="<?php echo $lang->language?>" id="<?php echo $lang->flag?>"><?php echo $lang->name?></option>
                <?php }?>
			</select>
		</div>
		...
		<div class="form-actions">
			<label class="checkbox"><input type="checkbox" name="remember" value="1"/><?php echo lang('remember');?>  </label>



            <button type="submit" class="btn blue pull-right"><?php echo lang('log');?>
		...
		<div class="forget-password">
			<h4><?php echo lang('forget');?></h4>
			<p><?php echo lang('no_worries');?>
                <a href="javascript:;" id="forget-password"><?php echo lang('here');?></a>
				<?php echo lang('to_reset');?>
           	</p>
		</div>
	...
	<form class="forget-form" action="<?php echo base_url()?>admin/forgot_password" method="post">
		<h3><?php echo lang('forget');?></h3>
		<p><?php echo lang('your_email');?></p>
		<div class="form-group">
			<div class="input-icon">
		...
		<div class="form-actions">
		  <button type="button" id="back-btn" class="btn"><i class="m-icon-swapleft"></i><?php echo lang('Back');?></button>
		  <button type="submit" class="btn blue pull-right"><?php echo lang('submit');?> <i class="m-icon-swapright m-icon-white"></i></button>
	   </div>
	<?php echo form_close();?>
...
<!-- BEGIN COPYRIGHT -->
<!--<div class="copyright">
	 2015 &copy; <?php //echo lang('site_title');?> - Admin Dashboard .
</div>-->
<!-- END COPYRIGHT -->
...
<script src="<?php echo base_url();?>assets/template/admin/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/template/admin/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
<script type="text/javascript" src="<?php echo base_url();?>assets/template/admin/global/plugins/select2/select2.min.js"></script>
<!-- END PAGE LEVEL PLUGINS -->
<script>
var assetsPath = '<?php echo base_url();?>assets/template/admin/';
...
<script src="<?php echo base_url();?>assets/template/admin/pages/scripts/login-soft.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script>
...
Layout.init(); // init current layout
  ...
  Demo.init();
       ...
       $.backstretch([
        "<?php echo base_url();?>assets/template/admin/pages/media/bg/1.jpg",
        "<?php echo base_url();?>assets/template/admin/pages/media/bg/2.jpg",
        "<?php echo base_url();?>assets/template/admin/pages/media/bg/3.jpg",
        "<?php echo base_url();?>assets/template/admin/pages/media/bg/4.jpg"
        ], {
          fade: 1000,
          duration: 8000
    }
