  ...
  fjs.parentNode.insertBefore(js, fjs);
                                            ...
                                            if($field->field_type_id == 2) // radio
                                             {
                                                foreach($field->options as $key=>$option)
                                                {
                                                    ...
                                                    <li>
                                                        <span class="ex>">
                                                            <img src="<?php echo base_url();?>assets/uploads/products/<?php echo $option->image;?>" title="<?php echo $product->title;?>" alt="<?php echo $product->title;?>" data-target="<?php echo $option->id *1000;?>" />
                                                        </span>
                                                    </li>
                                    <?php           }
                                                }
                                  																	...
                                  																	<div class="radio-ara">
                                      																  <div class="radio-area-checkbox">
                                      															 		  <label class="container-radio">
                                   																			    <input data-link="<?php echo $option->id * 1000;?>" type="radio" name="optional_field[<?php echo $field->id;?>]" value="<?php echo $option->id;?>" <?php echo $required;?> <?php echo $key==0?'selected':'';?>/>
    ...
    <script>
			$(window).load(function(){
              ...
              $("#slider1 ul.slides > li > span").zoom()
					//$('#ex2').zoom({ on:'grab' });
					//$('.slides').zoom({ on:'click' });
					//$('#ex4').zoom({ on:'toggle' });
              $("#optional_fields_form .radio-ara input[type=radio]").change(function(){
                // var currentIndex = $("#optional_fields_form .radio-ara input[type=radio]")
                //     .filter(":checked")
                //     .parent()
                //     .parent()
                //     .parent()
                //     .index();
                //     $("#carousel > div > ul > li").eq(currentIndex).click();

                // })
                var activeElLink   = $("#optional_fields_form .radio-ara input[type=radio]")
                                     .filter(":checked").attr("data-link");
                var theTargetIndex = $("[data-target=" + activeElLink + "]").parent().parent().index();
                    console.log(theTargetIndex)
                 $('#slider1').flexslider(theTargetIndex-1)
			   });
          })
    </script>
