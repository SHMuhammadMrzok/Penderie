...
<div style="display:none">
            ...
            <div class="row align-items-center">
                ...
                <div class="col logo">
                    <a href="<?php echo base_url();?>">
                        <img src="<?php echo base_url();?>assets/template/merchant/images/logo.png">
                    </a>
                </div>
            </div>
        </div>
    ...
    */?>
    ...
    <section class="welcome h-100">
        <div class="container-fluid no-gutters p-0 h-100">
            <div class="row h-100">
                    <div class="col-md-9 d-flex">
                            <div class="login">
                                    <div class="logo">
                                        <a href="https://storereem.com/"> 
                                            <img src="<?php echo base_url().'assets/uploads/'.$this->config->item('logo');?>" width="150" />
                                        </a>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                                <div class="col forget-pass">
                                                    <a href="<?php echo base_url();?>users/users/forget"><?php echo lang('forget');?></a>
                                                </div>
                                                <div class="col">
                                                    <div class="checkbox-input">
                                                        <input type="checkbox"  name="remember" value="1" id="checkbox-1" class="custom-checkbox"/>
                                                        <label for="checkbox-1"><?php echo lang('remember');?></label>
                                                    </div><!--checkbox-input-->
                                                </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-default h-50px"><?php echo lang('log');?></button>
                                    </div>
                                    <div class="form-group mb-0">
                                        <a href="<?php echo base_url();?>users/Register_store" class="sec-button h-50px"><?php echo lang('seller_join');?></a>
                                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="left-container">
                            <div class="message-login">
                                <span><?php echo lang('store_login_note');?></span>
                            </div>
                            <div class="social">
                                <ul>
                                    <li>
                            ...
                            <div class="copy-right">
                                <span><?php echo lang('copy_rights').' '.lang('store_name');?><span class="copy-icon"> &copy; </span><?php echo date('Y');?> </span>
                            </div>
                        </div>
                    </div>
            </div>
...
<script src="<?php echo base_url();?>assets/template/merchant/js/jquery.fancybox.min.js"></script>
